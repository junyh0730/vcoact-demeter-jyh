import time
from monitor.task_monitor_in_hyp import TaskMonitorinHPY
from monitor.hq_monitor import HQMonitor
from monitor.vq_monitor_in_hyp import VQMonitorinHPY
...
class Monitor():
    def __init__(self,env):
        ...
        self.start_time = -1
        self.end_time = -1
        self.taskm = TaskMonitorinHPY(env)
        self.hqm = HQMonitor(env)
        self.vqm = VQMonitorinHPY(env)
